...
* Request: endpoints that require authenticatoin
...
All endpoints that require authentication and the current user does not have the required roles or permissions.
...
Logs in a current user with valid crendentials and returns the current user's information.
...
* Request
    ...
    * Body:
     ```json
        {
            "credential": "JohnSmith@gmail.com",
